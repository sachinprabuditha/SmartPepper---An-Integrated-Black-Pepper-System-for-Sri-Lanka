                ...
                child: seasonsState.when(
                  data: (seasons) {
                    ...
                    final filteredSeasons = _selectedFarmId == null
                        ? sortedSeasons
                        : sortedSeasons
                            .where((season) => season.farmId == _selectedFarmId)
                            .toList();
                                          ...
                                          children: [
                                            Text(
                                              _selectedFarmId == null
                                                  ? context.tr(
                                                      'plantation_total_seasons')
                                                  : context.tr(
                                                      'plantation_filtered_seasons'),
                                ...
                                child: Padding(
                                  ...
                                  child: EmptyState(
                                    message: _selectedFarmId == null
                                        ? context
                                            .tr('plantation_no_seasons_yet')
                                        : context.tr(
                                            'plantation_no_seasons_for_farm'),
