class Environment {
  ...
  static const String apiBaseUrl =
      'http://192.168.8.151:3002/api'; // Physical device (Wi-Fi)

  // Uncomment for emulator:
  // static const String apiBaseUrl = 'http://10.0.2.2:3002/api';

  // Blockchain Configuration
  static const String blockchainRpcUrl = 'http://192.168.8.151:8545';
  ...
  static const String wsBaseUrl = 'http://192.168.8.151:3002';
  ...
  // IPFS Configuration
  static const String ipfsApiUrl = 'http://192.168.8.151:5001';
  static const String ipfsGatewayUrl = 'http://192.168.8.151:8080';
