...
export default function ExporterProfilePage() {
  ...
  // Redirect if not authenticated or not exporter
  useEffect(() => {
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              <div>
                ...
                />
                <p className="mt-1 text-xs text-gray-500 dark:text-gray-400">
                  Your Ethereum wallet address. Required to participate in auctions.
                </p>
              </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-yellow-800 dark:text-yellow-200 mt-1">
                        You need to add a wallet address to place bids and participate in auctions. Connect your MetaMask wallet or enter your address manually above.
                      </p>
                    </div>
                  </div>
                </div>
            ...
            <div className="flex items-center justify-end gap-4 pt-6 border-t border-gray-200 dark:border-gray-700">
              <button
                type="button"
                onClick={() => router.push('/dashboard/exporter')}
